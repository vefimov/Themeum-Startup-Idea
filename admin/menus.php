    ...
    <form id="themeum-startup-idea-options" role="form" method="post" action="options.php">
        ...
        <table class="form-table">
        	<tbody>
        		...
        		<tr>
        			<th scope="row"><label for="paypal_curreny_code"><?php _e('Currency', 'themeum-startup-idea'); ?></label></th>
        			<td>
        		...
        		<tr>
					<th><label for="donate_page_percentage"><?php _e('Per Project Commission','themeum-startup-idea'); ?></label></th>
					<td>
        		...
        		<tr>
					<th scope="row"><label for="profile_page_id"><?php _e('Profile/Dashboard Page','themeum-startup-idea'); ?></label></th>
					<td>
						<?php
				...
				<tr>
					<th scope="row"><label for="paypal_payment_checkout_page_id"><?php _e('Fund/Checkout Page','themeum-startup-idea'); ?></label></th>
					<td>
						<?php
        ...
        <h2><?php _e('Stipe Settings', 'themeum-startup-idea'); ?></h2>
        <p><small><?php _e('Stipe allows user to pay in crad like visa, mastard card etc.', 'themeum-startup-idea'); ?></small></p>
        ...
        <table class="form-table">
        	<tbody>
		        ...
		        <tr valign="top">
			        <th scope="row"><label for="stripe_secret_key"><?php _e('Stipe Publishable Key','themeum-startup-idea'); ?></label></th>
			        <td><input type="text" id="stripe_publishable_key" name="stripe_publishable_key" value="<?php echo esc_attr(get_option('stripe_publishable_key')); ?>" class="regular-text" /></td>
		        </tr>
...
function register_themeum_startup_idea_settings()
{
	...
	register_setting( 'themeum_startup_idea_options', 'stripe_publishable_key');
